...
?>
    <footer class="main-footer">
        <div class="inner-footer grid-row">
            <nav class="footer-nav">
                <h3 class="footer-kop">Navigatie</h3>
                <div class="nav-lists">
                    <ul>
                        <li><a href="/">Home</a></li>
                        <li><a href="/seaweed-course/seaweed/">Seaweed</a></li>
                        <li><a href="/seaweed-course/recepten/">Recepten</a></li>
                        <li><a href="/seaweed-course/about-us/">About us</a></li>
                    </ul>
                    <ul>
                        <li><a href="/seaweed-course/shop/">Shop</a></li>
                        <li><a href="/seaweed-course/blog/">Blog</a></li>
                        <li><a href="/seaweed-course/contact/">Contact</a></li>
                    </ul>
                </div>
            </nav>
            <div class="footer-socials">
                <h3 class="footer-kop">Socials</h3>
            ...
            <div class="footer-contact">
                <h3 class="footer-kop">Contact</h3>
                <ul>
                    <li>E-mail: <a href="mailto:seaweedcourse@gmail.com">seaweedcourse@gmail.com</a></li>
                    <li>Tel: <a href="tel:0611466145">0611466145</a></li>
                    <li>Zwolle</li>
                </ul>
            </div>
        </div>
        <div class="footer-copyright grid-row">
            <p>Copyright © SeaweedCourse 2022 | Algemene voorwaarden | Privacy beleid | Verkoop beleid</p>
        </div>
    </footer>
</div>
<?php wp_footer(); ?>
